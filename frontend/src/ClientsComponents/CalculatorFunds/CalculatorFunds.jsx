...
const CalculatorFunds = () => {
  ...
  return (
    <div className="h-screen p-10">
      <p className="text-center text-4xl font-bold">Choose Your Calculator</p>

      <p>
        Select Your Calculator
        <Select
          options={typesOfCalculator}
          onChange={(option) => setCurrentCalcualtor(option.value)}
