            ...
            <div className="flex justify-center py-10">
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4 rounded-2xl w-full md:w-2/3 bg-[#87CEFA]/80 p-6'>
                    <div className='flex flex-col space-y-10 text-white rounded-l-2xl'>
                        ...
                        <div className='space-y-4'>
                            <div className='flex justify-between'>
                                <label htmlFor="monthly-contribution" className="block mb-2 text-lg font-medium">Monthly Contribution</label>
                                <span className='flex items-center'>
                                    <span className='px-2'>₹</span>
                                    <input
                                        type="number"
                        ...
                        <div className='space-y-4'>
                            <div className='flex justify-between'>
                                <label htmlFor="annual-return" className="block mb-2 text-lg font-medium">Annual Return</label>
                                <span className='flex items-center'>
                                    <span className='px-2'>%</span>
                                    <input
                                        type="number"
                                        ...
                                        className='bg-transparent px-2 text-xl w-32 text-center'
                                        value={annualReturn}
                                        onChange={(e) => setAnnualReturn(Math.max(e.target.value, 0.01))}
                                        min={0.01}
                                        step={0.01}
                                    />
                                </span>
                        ...
                        <div className='space-y-4'>
                            <div className='flex justify-between'>
                                <label htmlFor="investment-period" className="block mb-2 text-lg font-medium">Investment Period</label>
                                <span className='flex items-center'>
                    ...
                    <div className='border border-[#87CEFA]/80 bg-white flex flex-col justify-center items-center rounded-r-2xl p-4'>
                        ...
                        <div className='text-2xl font-semibold'>₹ {futureValue !== null ? futureValue : '0.00'}</div>
                        <button 
