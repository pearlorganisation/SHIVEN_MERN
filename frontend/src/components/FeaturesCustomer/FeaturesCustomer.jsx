...
import DashboardI from "../../assets/Financial/DashboardI.svg";
import FormsI from "../../assets/Financial/FormsI.svg";
...
const FeaturesCustomer = () => {
  const team = [
    ...
    {
      avatar:
        "https://parentportfolio.com/wp-content/uploads/2022/09/Invest-Money-in-the-Bank-vs.-Invest-in-Land.jpg",
    ...
    {
      avatar:
        "https://img.freepik.com/premium-vector/file-protection-folder-with-files-documents-computer-trendy-isometric-style_168129-554.jpg",
      name: "Files / Folder Management",
    ...
    {
      avatar:
        "https://hearst-images.s3.amazonaws.com/getty/article/81/200/78253591_XS.jpg",
      name: "Customer / Family Profile",
    ...
    {
      avatar: "https://upraise.io/wp-content/uploads/2019/12/Asset-1-1.png",
    ...
    {
      avatar:
        "https://www.hiveage.com/assets/posts/3701/a-guide-to-proforma-invoices.jpg",
      name: "Purchase / Renewal / Invoices",
