const Footer = () => {
  ...
  return (
    <footer className="text-gray-500 bg-[lightskyblue] w-[100%] mx-auto md:px-8 border-t p-6">
      <div className="max-w-lg sm:mx-auto sm:text-center">
        <div className="flex items-center justify-between py-3 md:py-5 md:block ">
          <p className="text-3xl md:text-5xl font-semibold text-indigo-500 font-mono flex justify-center">
            SHIVEN
          </p>
        </div>
        <p className="leading-relaxed mt-2 text-[15px] text-black font-bold ">
      ...
      <ul className="items-center justify-center mt-8 space-y-5 sm:flex sm:space-x-4 sm:space-y-0">
        {footerNavs.map((item, idx) => (
          <li className=" hover:text-gray-800 text-black">
      ...
      <div className="mt-8 items-center justify-between sm:flex">
        <div className="mt-4 sm:mt-0 text-black">
          &copy; 2024 Shiven Tech All rights reserved.
        </div>
