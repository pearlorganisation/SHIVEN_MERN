              ...
              >
                <div class="p-6">
                  <div class="flex items-center space-x-4 mb-4">
                    <span class="relative flex h-10 w-10 shrink-0 overflow-hidden rounded-full">
                      <img
                        ...
                        alt="Niva Bupa"
                        src="https://ins-common-logos-stage.s3.ap-south-1.amazonaws.com/brokerage/logo/health/niva-bupa4x.png"
                      />
                    </span>
                    <div>
                      <h3 class="font-semibold">Reassure</h3>
                  ...
                  <div class="flex justify-between items-center">
                    <p class="text-gray-600">Starting From ₹773/month*</p>
              ...
              >
                <div class="p-6">
                  <div class="flex items-center space-x-4 mb-4">
                    ...
                    <div>
                      <h3 class="font-semibold">Health Recharge</h3>
                      <p class="text-sm text-gray-600">
                        Individual/floater plan
                      </p>
                    </div>
                  ...
                  <div class="flex justify-between items-center mb-4">
                    <p class="text-gray-600">COVER 10 Lakh</p>
                    <p class="text-gray-600">CASHLESS HOSPITAL 10059</p>
                  </div>
                  <div class="flex justify-between items-center">
                    <p class="text-gray-600">Starting From ₹81/month*</p>
                    <button class="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-primary/90 h-10 px-4 py-2 bg-red-500 text-white">
                      Check Premium
                    </button>
                  </div>
              ...
              >
                <div class="p-6">
                  <div class="flex items-center space-x-4 mb-4">
                    ...
                    <div>
                      <h3 class="font-semibold">Health Pulse</h3>
                      <p class="text-sm text-gray-600">
                        Individual/floater plan
                      </p>
                    </div>
