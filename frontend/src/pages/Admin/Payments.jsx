...
const Payments = () => {
  ...
  const sampleData = [
    {
      _id: "111",
      name: "Shashank",
      razorpayPaymentId: "a25gr5e5f4s",
      Amount: "2000",
      Service: "Customised Plan"
    },
    {
      _id: "112",
      name: "Nayan",
  ...
  return (
    <div>
      ...
      <div className="p-10 ">
        <div className="text-2xl">Payment Logs</div>
        <div className="mt-10">
                ...
                <tbody>
                  {data.map((item, idx) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">{item?.razorpayPaymentId}</td>
