...
const LifeInsurance = () => {
  ...
  const fields = [
    ...
    { name: "premiumPaymentMode", placeholder: "Premium Payment Mode", type: "text" },
    { name: "premiumDate", placeholder: "Premium Date", type: "date" },
    { name: "premiumAmount", placeholder: "Premium Amount", type: "number" },
    { name: "lastDateOfPremium", placeholder: "Last Date of Premium", type: "date" },
    { name: "maturityDate", placeholder: "Maturity Date", type: "date" },
    { name: "sumAssured", placeholder: "Sum Assured", type: "number" },
    { name: "maturityAmount", placeholder: "Maturity Amount", type: "number" },
