...
const MutualFundSIP = () => {
  ...
  const fields = [
    ...
    { name: "sipDate", placeholder: "SIP Date", type: "date" },
    { name: "sipAmount", placeholder: "SIP Amount", type: "number" },
    { name: "noOfUnits", placeholder: "No. Of Units", type: "number" },
    { name: "purchaseNAV", placeholder: "Purchase NAV", type: "number" },
    { name: "marketValue", placeholder: "Market Value", type: "number" },
    { name: "currentNAV", placeholder: "Current NAV", type: "number" },
    { name: "marketValue2", placeholder: "Market Value (Current)", type: "number" },  // Renamed to avoid key duplication
