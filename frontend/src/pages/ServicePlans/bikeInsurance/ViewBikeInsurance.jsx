  ...
  return (
    <div className="userContainer p-10 ">
      <div className="title p-1">
        ...
        <div className="createEmployeeBtn flex justify-end p-4 ">
          <button
            ...
            onClick={() => {
              navigate("/servicePlan/bike-insurance");
            }}
          >
          Add Bike Insurance Plan
          </button>
        </div>
      </div>
      <div className="mt-6 shadow-xl rounded-lg overflow-x-auto">
          ...
          {showViewModal && (
        <ViewBikeModal setModal={setShowViewModal} viewData={viewData} />
      )}
      {showDeleteModal && (
...
export default ViewBikeInsurance