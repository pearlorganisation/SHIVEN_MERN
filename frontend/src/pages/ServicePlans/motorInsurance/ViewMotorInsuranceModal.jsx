...
export default function ViewMotorInsuranceModal ({viewData,setModal}) {
  ...
  >
    ...
    <tbody className="text-gray-600">
      ...
      <tr>
        <td className="py-2 px-4 border border-gray-300">IDV</td>
        <td className="py-2 px-4 border border-gray-300">dummy</td>
      </tr>
      <tr>
        <td className="py-2 px-4 border border-gray-300">Claims settled (%)</td>
        <td className="py-2 px-4 border border-gray-300">dummy</td>
      </tr>
      <tr>
        <td className="py-2 px-4 border border-gray-300">Zero Depreciation</td>
        <td className="py-2 px-4 border border-gray-300">dummy</td>
      </tr>
