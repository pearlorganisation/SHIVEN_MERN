...
export default function ViewModalVehicleLoan ({viewData,setModal}) {
  ...
  >
    ...
    <tbody className="text-gray-600">
      ...
      <tr>
        <td className="py-2 px-4 border border-gray-300">Interest Rate (%)</td>
        <td className="py-2 px-4 border border-gray-300">{viewData?.interestRate}</td>
      </tr>
      <tr>
      ...
      <tr>
        <td className="py-2 px-4 border border-gray-300">Vehicle Type</td>
        <td className="py-2 px-4 border border-gray-300">{viewData?.vehicleType}</td>
      </tr>
