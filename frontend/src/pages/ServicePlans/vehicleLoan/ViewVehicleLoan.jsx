...
import ViewModalVehicleLoan from './ViewModalVehicleLoan';


const ViewVehicleLoan = () => {
      ...
      <div className="title p-1">
        ...
        <div className="createEmployeeBtn flex justify-end p-4 ">
          <button
            ...
            onClick={() => {
              navigate("/servicePlan/vehicle-loan");
            }}
          >
          Add Vehicle Loan Plan
          </button>
        </div>
      </div>
...
export default ViewVehicleLoan